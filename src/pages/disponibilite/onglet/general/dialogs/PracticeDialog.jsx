// src/components/PracticeDialog.jsx
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        {/* Ligne de temps */}
        <div className="relative" style={{ height: '10px', background: '#e0e0e0' }} onClick={handleTimelineClick}>
            ...
            <ul>
              {practices.map((practice, idx) => (
                <li key={idx} className="flex items-center justify-between">
                  <span>
                    {practice.type} : {practice.start} - {practice.end}
                  </span>
            ...
            <div className="flex flex-row w-full justify-between items-center px-2">
              ...
              <label>
                ...
                <input
                  ...
                  onChange={onPracticeStartChange}
                  onBlur={onPracticeStartBlur}
        ...
        <DialogFooter>
          <Button onClick={onSavePractices}>Enregistrer</Button>
          <Button onClick={onOpenChange}>Annuler</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
